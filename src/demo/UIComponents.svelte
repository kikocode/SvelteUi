...
<Button color={randomColor} on:click={setRandomColor} outlined={true} style="border-width: 2px; border-radius: 50px;">
...
<Block>
  ...
  <div class="testElement">
    <Select
      ...
      compact={false}
      prepend="$"
      helperText="Prepend" ><option></option>
        <option>Test</option>
  ...
  <Select
    ...
    compact={false}
    append="$$"
    helperText="Append" ><option></option>
        <option>Test</option>
        <option>OptionWithLongText</option>
        </Select>
  ...
  <Select
    ...
    append="-Append-"
    variant="filled"
    helperText="Append/Prepend" ><option></option>
        <option>Test</option>
        <option>OptionWithLongText</option>
        </Select>
  ...
  <Select
    ...
    prepend="$$$"
    append="¢¢¢"
    helperText="Compact" ><option></option>
        <option>Test</option>
        <option>OptionWithLongText</option>
        </Select>
  ...
  <Select
    ...
    append="$-8"
    variant="filled"
    helperText="Error" ><option></option>
        <option>Test</option>
        <option>OptionWithLongText</option>
        </Select>
  ...
  <Select
    ...
    append="$"
    variant="simple"
    helperText="Simple" ><option></option>
        <option>Test</option>
        <option>OptionWithLongText</option>
        </Select>
  ...
  <Select
    ...
    variant="outlined"
    helperText="2 Icons" ><option></option>
        <option>Test</option>
        <option>OptionWithLongText</option>
        </Select>
